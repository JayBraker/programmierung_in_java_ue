...
public class Bruch
{
    ...
    {
        this(zaehler, nenner, new SchraegStrichFormat());
        if (nenner == 0)
        {
    ...
    public Bruch(int zaehler, int nenner, BruchFormat format)
    {
        if (nenner == 0)
        {
            throw new ArithmeticException("Nenner gleich 0");
        }
        this.bruchFormat = format;
        this.zaehler = zaehler;
        this.nenner = nenner;
        this.normalisiere();
    }
    ...
    {
        return this.bruchFormat.bruchToString(this.zaehler, this.nenner);
    }
    ...
    /**
     * @return the bruchdarstellung
     */
    public BruchFormat getBruchdarstellung()
    {
        return this.bruchFormat;
    }

    /**
     * @param bruchdarstellung the bruchdarstellung to set
     */
    public void setBruchdarstellung(BruchFormat bruchdarstellung)
    {
        this.bruchFormat = bruchdarstellung;
    }
