...
/**
 * Zweck: Fuer Praesenzuebung zu verwendende Klasse, die den Rahmen bietet, um
 * geometrische Figuren auf dem Bildschirm anzeigen zu lassen.<br>
...
public class Grafik
{
     ...
     * 
     * @param verzoegerung Zeit in Millisekunden, die vor der Aktualisierung
     * gewartet wird.
     */
...
abstract class Figur
{
    ...
    public void paint(Graphics g)
    {
        ...
        {
            g.drawLine(getPunkt(i).x, getPunkt(i).y, getPunkt(i + 1).x,
                    getPunkt(i + 1).y);
        }
    }
