...
/**
 * Zweck: Fuer Praesenzuebung zu verwendende Klasse, die den Rahmen bietet, um geometrische Figuren
 * auf dem Bildschirm anzeigen zu lassen.<br>
...
public class Grafik {
  ...
  /**
   * Aktualisiert die Zeichenflaeche. Aenderungen werden erst sichtbar, nachdem diese Methode
   * aufgerufen wurde. Vor der Aktualisierung wird ms Millisekunden gewartet.<br>
   * Damit ist eine einfache Animation moeglich.
   *
   * @param verzoegerung Zeit in Millisekunden, die vor der Aktualisierung gewartet wird.
   */
...
abstract class Figur {
  ...
  /**
   * Gibt die Anzahl an Punkten zurueck. Es handelt sich um eine abstrakte Methode die in allen
   * Unterklassen von Figur ueberschrieben werden muss
   *
   * @return Punktanzahl
   */
  ...
  /**
   * Gibt den zum index gehoerenden Punkt zurueck. Es handelt sich um eine abstrakte Methode die in
   * allen Unterklassen von Figur �berschrieben werden muss
   *
   * @param i Punktindex
  ...
  /**
   * Diese Methode zeichnet zwischen den jeweils benachbarten Punkten der Liste eine
   * Verbindungslinie.
   *
   * @param g Graphikobjekt, auf dem die Punkte der Figur eingezeichnet werden
   */
  public void paint(Graphics g) {
