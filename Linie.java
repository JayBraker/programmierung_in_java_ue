...
public class Linie extends Figur {
  ...
  @Override
  /**
   * Gibt die Anzahl an Punkten des Polygonszugs dieser Figur zurueck. Ueberschreibt die abstrakte
  ...
  @Override
  /**
   * Gibt den gewuenschten Punkt des Polygonszugs dieser Figur zurueck. Ueberschreibt die abstrakte
   * Methode der Basisklasse.
   *
  ...
  /**
   * Erstellt das Objekt fuer eine Linie, die zwischen den beiden uebergebenen Punkten verlaeuft
   *
